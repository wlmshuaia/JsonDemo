...
import com.wlm.test.extend.WebMvcConfigurationSupportAdapter;

/**
 * {@link RequestMapping} 方法扩展，自定义实现 {@link UrlPathHelper}, {@link PathMatcher}
 * <p>该实现主要目的为扩展 SpringMVC-4.0.3 以前的版本，4.0.3 以后的版本框架可通过 {@link WebMvcConfigurationSupportAdapter} 自定义实现</p>
 *
 * @author wengliemiao
 */
//@Component
